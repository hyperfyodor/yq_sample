...
const (
	ConsumerService_ProcessTask_FullMethodName = "/consumer.ConsumerService/ProcessTask"
)
...
func (c *consumerServiceClient) ProcessTask(ctx context.Context, in *ProcessTaskRequest, opts ...grpc.CallOption) (*ProcessTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProcessTaskResponse)
	err := c.cc.Invoke(ctx, ConsumerService_ProcessTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedConsumerServiceServer) ProcessTask(context.Context, *ProcessTaskRequest) (*ProcessTaskResponse, error) {
...
func _ConsumerService_ProcessTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProcessTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsumerServiceServer).ProcessTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConsumerService_ProcessTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsumerServiceServer).ProcessTask(ctx, req.(*ProcessTaskRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ConsumerService_ProcessTask_Handler,
		},
	},
